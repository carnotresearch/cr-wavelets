...
intersphinx_mapping = {
    ...
    "cr.sparse": ("https://cr-wavelets.readthedocs.io/en/latest/", None),
}
...
latex_documents = [
    (master_doc, "CRWavelets.tex", "CR-Wavelets", "CR-Suite Development Team", "manual"),
]
