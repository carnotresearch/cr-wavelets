...
* [CR-Wavelets reference documentation](https://carnotresearch.github.io/cr-wavelets/)
...
* Fork the repository associated with the issue to your local GitHub organization. 
  This means that you will have a copy of the repository under your-GitHub-username/cr-wavelets.

* Clone the repository to your local machine using 
  `git clone https://github.com/your-user-name/cr-wavelets.git`.
...
If you need help, you can ask questions on our [Discussions](https://github.com/carnotresearch/cr-wavelets/discussions) forum for this project.
