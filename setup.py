...
exec(open('src/cr/wavelets/version.py').read())
...
setup(
    ...
    url='https://carnotresearch.github.io/cr-wavelets',
    download_url=f"https://github.com/carnotresearch/cr-wavelets/archive/v{__version__}.tar.gz",
